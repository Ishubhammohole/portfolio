    ...
    <section id="hero" className="min-h-screen flex items-center justify-center px-6 lg:px-8 pt-16">
      <div className="max-w-6xl w-full">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <div className="relative">
              ...
              <img
                src={profileImage}
                alt="Shubham Mohole"
                className="relative w-48 h-48 rounded-full object-cover ring-4 ring-primary"
          ...
          >
            <span className="px-4 py-2 bg-primary/10 text-primary border border-primary/20 rounded-full font-mono text-sm">
